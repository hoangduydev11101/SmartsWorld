...
public class NoiBatAdater extends BaseAdapter {

    Context context;
    int layout;
    List<SanPham> arrSanPham;

    public NoiBatAdater(Context context, int layout, List<SanPham> arrSanPham) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(rowview == null){
            rowview = inflater.inflate(R.layout.dong_noibat, null);
            ...
            holder = (NoiBatAdater.ViewHolder) rowview.getTag();
        }
